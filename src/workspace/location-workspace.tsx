export type LocationWorkspaceRecord = {
  id: string;
  name: string;
  notionPageId: string;
...
export function LocationWorkspaceSurface({
  location,
}: {
  location: LocationWorkspaceRecord;
}) {
  return (
        ...
        <article className="rounded-lg border border-slate-200 bg-white p-4">
          ...
          <dl className="mt-3 grid gap-3 text-sm text-slate-600">
            ...
            <div>
              ...
              <dd className="break-all">{location.notionPageId}</dd>
            </div>
            <div>

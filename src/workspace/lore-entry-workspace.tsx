...
export type LoreEntryWorkspaceRecord = {
  id: string;
  name: string;
...
export function LoreEntryWorkspaceSurface({
  loreEntry,
}: {
  loreEntry: LoreEntryWorkspaceRecord;
}) {
  return (
        ...
        <article className="rounded-lg border border-slate-200 bg-white p-4">
          ...
          <dl className="mt-3 grid gap-3 text-sm text-slate-600">
            ...
            <div>
              ...
              <dd className="break-all">{loreEntry.notionPageId}</dd>
            </div>
            <div>
